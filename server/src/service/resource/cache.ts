...
export function buildSnapshot(
  ...
  return {
    ...
    dns_avg_ms: dnsRing.avg() != null ? Math.round(dnsRing.avg()!) : null,
    dns_p50_ms: dnsRing.percentile(50) != null ? Math.round(dnsRing.percentile(50)!) : null,
    dns_p95_ms: dnsRing.percentile(95) != null ? Math.round(dnsRing.percentile(95)!) : null,
    dns_p99_ms: dnsRing.percentile(99) != null ? Math.round(dnsRing.percentile(99)!) : null,
