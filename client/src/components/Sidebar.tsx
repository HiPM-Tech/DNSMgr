...
import {
  LayoutDashboard, Server, Globe, Users, UserCog, Settings, LogOut, Zap, FileText, Info, Cpu, Sun, Moon, Monitor, Key, ShieldCheck,
} from 'lucide-react';
...
const navItems = [
  ...
  { to: '/certificates', icon: ShieldCheck, key: 'common.certificates' },
