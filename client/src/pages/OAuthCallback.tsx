...
import { Button, Card, Loading } from 'tdesign-react';
...
export function OAuthCallback() {
  ...
  if (error && !succeeded) {
    return (
      <div className="callback-shell">
        <Card bordered={false} shadow className="callback-card">
          <ErrorCircleIcon className="callback-card__error" />
  ...
  return (
    <div className="callback-shell">
      <Card bordered={false} shadow className="callback-card">
        <Loading loading size="large" text={processing ? t('common.loading') : t('common.redirecting')} />
      </Card>
    </div>
  );
}
