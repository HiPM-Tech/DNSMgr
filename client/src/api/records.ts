...
export const recordsApi = {
  ...
  exportZone: (domainId: number, nameFormat?: 'relative' | 'full') =>
    api.get<ApiResponse<{ content: string; filename: string }>>(`/domains/${domainId}/records/export/zone`, { params: { nameFormat } }),
